...
namespace VIDE_Data
{
    ...
    */
    ...
    public class DialogueNode
    {
        ...
        public List<Comment> playerOptions;
        public int ID;
        ...
        public DialogueNode()
        {
            ...
            playerOptions = new List<Comment>();
        }
        ...
        public DialogueNode(DialogueNode n)
        {
            ...
            foreach(Comment pO in n.playerOptions)
            {
    ...
    public class VD : MonoBehaviour
    {
        ...
        public class NodeData
        {
            ...
            public NodeData(NodeData nd)
            {
                ...
                playerOptions = nd.playerOptions;
        ...
        private static string[] GetComments(DialogueNode diagNode)
        {
        ...
        public static void LoadFromVA(VIDE_Assign diagToLoad)
        {
            ...
            if (theIndex == -1)
            {
                Debug.LogError("'" + diagToLoad.assignedDialogue + "' dialogue assigned to " + diagToLoad.name + " not found! Did you delete the dialogue?");
                return;
            }
        ...
        private static NodeData GetNodeDataForPlayer(DialogueNode diagNode)
        {
            ...
            nd.comments = GetComments(diagNode);
            ...
            nd.playerOptions = GetOptions(diagNode);

            List<Comment> poRefs = new List<Comment>();
            foreach (Comment po in diagNode.playerOptions)
                poRefs.Add(po);
            nd.poreferences = poRefs.ToArray();
